        ...
        <?php echo Form::open(array('id'=>'editform', 'method'=>'PATCH', 'enctype'=>'multipart/form-data','class'=>'form-horizontal col-lg-6 col-md-7 col-sm-12 col-xs-12','style'=>'padding-left:0')); ?>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
                    ...
                    <i style="position:relative;margin:-46px 0 0 10px;color:gray;font-size:85%">*file gambar tidak harus diubah</i><br/>
            ...
            <div class="form-group col-lg-10 col-md-10 col-sm-12 col-sm-12" style="margin-bottom:50px;padding-top:30px">
                ...
                <button style="float:left;margin:0px 5px 5px 0" class="btn btn-default awal">kembali</button>
            </div>
    </div>
</div>