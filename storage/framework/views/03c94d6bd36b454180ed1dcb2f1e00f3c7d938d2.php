                    ...
                    <td align="center">
                        ...
                        <script>
                            $(document).ready(function(){
                                ...
                                var timeout;
                                function loaded() {
                                    $('#img<?php echo e($key); ?>').html('<img width="100px" src="<?php echo e(elixir('images/'.$item->file)); ?>" class="btn-img" style="border:1px solid #eee" title="lihat gambar" alt="not found" onclick="lightbox(<?php echo $key ?>)">');
                                }
                                function startLoad() {
                                    $('#img<?php echo e($key); ?>').html('<img width="30px" src="<?php echo e(elixir('loader.gif')); ?>"/>');
                                    clearTimeout(timeout);
                                    timeout = setTimeout(loaded, <?php echo e($key+2); ?>00);
                                }
                            })
                        </script>
                    </td>
