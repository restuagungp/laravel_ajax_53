...
<head>
    ...
    <!--bootstrap validator-->
    <!--link rel="stylesheet" href="<?php echo e(elixir('bootstrapvalidator/vendor/jasmine/jasmine.css')); ?>"-->
    ...
    <!--script type="text/javascript" src="<?php echo e(elixir('bootstrapvalidator/vendor/jasmine/jasmine.js')); ?>"></script-->
    <!--script type="text/javascript" src="<?php echo e(elixir('bootstrapvalidator/vendor/jasmine/jasmine-html.js')); ?>"></script-->
    ...
    <style>
        ...
        .total{ margin-top:20px;color:#636363;padding-top:7px;padding-bottom:7px;text-align:center;border-top:1px solid #C0C0C0;border-bottom:1px solid #C0C0C0
        }
...
<body id="app-layout">
    ...
    <a class="cd-top">Documentation by restu  </a> <!-- untuk menampilkan btt -->
    <!-- pagination -->
    <script type="text/javascript" src="<?php echo e(elixir('js/jquery.twbsPagination.min.js')); ?>"></script>
