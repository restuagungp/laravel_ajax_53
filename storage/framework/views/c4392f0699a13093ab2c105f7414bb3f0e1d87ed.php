<?php $__env->startSection('content'); ?>
        ...
        <div class="col-md-10 col-md-offset-1">
            <div id="awal" class="col-lg-12 col-md-12" style="padding:0">
                ...
                <div id="tabel" class="result" style="clear:both">
                    ...
                    <?php echo $__env->make('kendaraan_ajax_modal/tabeldatakendaraan', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="formaddmodal" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php echo Form::open(array('method'=>'PATCH', 'enctype'=>'multipart/form-data', 'id'=>'upload_form' , 'class'=>'form-horizontal')); ?>
    ...
    $(document).ready(function(e){
        ...
        $('#search').on('keyup',function(){
            ...
            $.ajax({
                type : 'get',
                url  : '<?php echo e(URL::to('searchitem-ajax-modal')); ?>',
                data : {'search':$value},
                success : function(data){
                    $('tbody').html(data);
                },
