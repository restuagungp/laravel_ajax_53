...
<head>
    ...
    <link rel="stylesheet" href="{{ elixir('css/btt.css') }}">
    <script src="{{ elixir('js/modernbtt.js') }}"></script>

    <title>CRUD</title>

    <!-- Fonts -->
    <link rel="stylesheet" href="{{ elixir('css/font-awesome.min.css') }}">
    <link rel="stylesheet" href="{{ elixir('css/font-family.css') }}">
    <!-- Styles -->
    {{-- <link href="{{ elixir('css/app.css') }}" rel="stylesheet"> --}}
    <!-- jquery -->
    <script src="{{ elixir('js/jquery.min.js') }}"></script>
    <!--autocomplete-->
    <link rel="stylesheet" href="{{ elixir('css/jquery.ui.autocomplete.css') }}">
    <script src="{{ elixir('js/jquery-ui.min.js') }}"></script>    
    <!--bootstrap validator-->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/3.3.6/css/bootstrap.min.css" integrity="sha384-1q8mTJOASx8j1Au+a5WDVnPi2lkFfwwEAa8hDDdjZlpLegxhjVME1fgjWPGmkzs7" crossorigin="anonymous">
    <link rel="stylesheet" href="{{ elixir('bootstrapvalidator/dist/css/formValidation.css') }}">
    <script type="text/javascript" src="{{ elixir('bootstrapvalidator/dist/js/formValidation.js') }}"></script>
    <script type="text/javascript" src="{{ elixir('bootstrapvalidator/dist/js/framework/bootstrap.js') }}"></script>
...
<body id="app-layout">
        ...
        <div class="container" style="margin-left:0;padding-left:0">
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav">
                    <li class="menu"><a href="{{ url('/') }}" style="font-weight:bold">LARAVEL 5.3</a></li>
                     <li><a href="{{ url('/kendaraan') }}">CRUD</a></li>
                     <li><a href="{{ url('/kendaraan-ajax-modal') }}">CRUD-AJAX::MODAL</a></li>
                     <li><a href="{{ url('/kendaraan-ajax-show') }}">CRUD-AJAX::SHOW-HIDE</a></li>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <!-- image preview -->
    <script type="text/javascript" src="{{ elixir('js/preview_images.js') }}"></script>
    <!-- pagination -->
    <script type="text/javascript" src="{{ elixir('js/pagination.js') }}"></script>
    <!-- validator -->
    <script type="text/javascript" src="{{ elixir('js/validator.min.js') }}"></script>
    <!-- JavaScripts -->
    <script type="text/javascript" src="{{ elixir('js/bootstrap.min.js') }}"></script>
    <!-- notification -->
    <script type="text/javascript" src="{{ elixir('js/toastr.min.js') }}"></script>
    <link  rel="stylesheet" href="{{ elixir('css/toastr.css') }}">

    {{-- <script type="text/javascript" src="{{ elixir('js/app.js') }}"></script> --}}
    <script type="text/javascript" src="{{ elixir('js/mainbtt.js') }}"></script>
</body>
</html>