<div class="row">
    <div class="col-md-10 col-md-offset-1" style="margin-left:20px">
        ...
        {!! Form::open(array('id'=>'editform', 'method'=>'PATCH', 'enctype'=>'multipart/form-data','class'=>'form-horizontal col-lg-6 col-md-7 col-sm-12 col-xs-12','style'=>'padding-left:0')) !!}
            ...
            <div class="form-group" >
                ...
                <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
                    {!! Form::text('jenis_edit', null, ['autofocus'=>'autofocus', 'class' => 'jenis form-control', 'maxlength'=>'30']) !!}
                </div>
            </div>
            <div class="form-group">
                <label class="col-lg-2 col-md-2 control-label" style="text-align:left">Nama</label>
                <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
                    {!! Form::text('nama_edit', null, ['class' => 'nama form-control', 'maxlength'=>'25']) !!}
                </div>
            </div>
            <div class="form-group">
                <label class="col-lg-2 col-md-2 control-label" style="text-align:left">Harga</label>
                <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
                    {!! Form::text('harga_edit', null, ['class' => 'harga form-control', 'style'=>'padding-left:33px', 'maxlength'=>'18']) !!}
