            ...
            <div id="awal" class="col-lg-12 col-md-12" style="padding:0">
                <div id="tabel" style="clear:both">
                    <div class="col-lg-12 col-md-12" style="padding:0">
                        <form action="{{url('search-ajax-show')}}" method="get" id="frmsearch" class="form-horizontal col-lg-6 col-md-6 col-sm-7" style="padding:0;margin:0 0 10px 0;">
                        ...
                        <div class="row col-lg-6 col-md-6 col-sm-5" style="margin:0 0 10px 0;padding:0">
                            ...
                            <a href="{{url('pdf-kendaraan')}}" target="blank" class="pdf col-lg-2 col-md-2 col-sm-2 btn btn-info pull-right">
                                <span class="glyphicon glyphicon-save-file"></span>&nbsp PDF
                            </a>
                        </div>
                    </div>            
                    <div class="result">
                        @include('kendaraan_ajax_show/tabeldatakendaraan')
                    </div>
                </div>
            </div>

            <div id="tab_tambah" style="margin-top:-15px"> 
                @include('kendaraan_ajax_show/form_tambah')
            </div>
            <div id="tab_ubah" style="margin-top:-15px">
                @include('kendaraan_ajax_show/form_ubah')
            </div>
            <div id="deletemodal" class="modal fade" role="dialog">
                @include('kendaraan_ajax_show/modal_delete')
            </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            $(document).on('click', '.awal', function() {
                reset(); //melakukan reset form sebelum masuk ke halaman awal
                $('#awal').fadeIn(250);
                $('#tab_tambah').hide();
                $('#tab_ubah').hide();
            });
            ...
            //=============================================================
            // aksiubah btn editform                                        
            //=============================================================
            $('.aksi').on('click', '.edit', function() {
                aksiubahdata_proses();
            })
            function aksiubahdata(e){
                if (e.keyCode == 13) {
                    aksiubahdata_proses();
                }
            }
            function aksiubahdata_proses(){
