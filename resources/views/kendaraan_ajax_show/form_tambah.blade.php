<div class="row">
    <div class="col-md-10 col-md-offset-1" style="margin-left:20px">
        ...
        {!! Form::open(array('id'=>'addform', 'method'=>'PATCH', 'enctype'=>'multipart/form-data','class'=>'form-horizontal col-lg-6 col-md-7 col-sm-12 col-xs-12','style'=>'padding-left:0')) !!}
            
            <div class="form-group" >
                <label class="col-lg-2 col-md-2 control-label" style="text-align:left">Jenis</label>
                <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
                    {!! Form::text('jenis_add', null, ['autofocus'=>'autofocus', 'class' => 'form-control', 'maxlength'=>'30']) !!}
                </div>
            </div>
            <div class="form-group">
                <label class="col-lg-2 col-md-2 control-label" style="text-align:left">Nama</label>
                <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
                    {!! Form::text('nama_add', null, ['class' => 'form-control', 'maxlength'=>'30']) !!}
                </div>
            </div>
            <div class="form-group">
                <label class="col-lg-2 col-md-2 control-label" style="text-align:left">Harga</label>
                <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
                    {!! Form::text('harga_add', null, ['class' => 'form-control', 'style'=>'padding-left:33px', 'maxlength'=>'18']) !!}
            ...
            <div class="form-group col-lg-10 col-md-10 col-sm-12 col-sm-12" style="margin-bottom:50px;padding-top:30px">
                <div class="aksi" style="float:left">
                    <button style="float:left;margin:0 5px 5px 0" class="btn btn-info actionadd">simpan</button>&nbsp
